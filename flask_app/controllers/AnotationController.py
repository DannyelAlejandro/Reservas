...
@app.route('/anotations/create', methods = ['GET'])
def createAnotations():
    return render_template('anotations/create.html')

@app.route('/anotations/edit/<id>', methods = ['GET'])
def editAnotations(id):
    data = Anotation.find(id)
    return render_template('anotations/edit.html', data = data[0], id = id)
